...
| .bash_profile                     | An example of a profile to export the pre-authenticated URL to the storage bucket.                                            |
...
8. Modify the .bash_profile file as shown in code example in .bash_profile of this repository.
...
14. Modify the 001_main.tf file provided in this repo with the full URL to the
    ...
    CAVEAT: The pre-authorization key must have read-write access. The expiration value
    of this key should be very short. Always generate a new value when pushing new
